...
- Store newly generated plan images as imported project assets keyed by stable plan slugs; this preserves image-to-plan mapping if names change and keeps reference uploads out of the app.
